...
cat $dir/opensubs.dev.$src | $mosesdir/tokenizer/normalize-punctuation.perl -l $src | $mosesdir/tokenizer/tokenizer.perl -a -threads 8 -l $src > $dir/1-tok/opensubs.dev.tok.$src
cat $dir/opensubs.dev.$trg | $mosesdir/tokenizer/normalize-punctuation.perl -l $trg | $mosesdir/tokenizer/tokenizer.perl -a -threads 8 -l $trg > $dir/1-tok/opensubs.dev.tok.$trg
cat $dir/opensubs.test.$src | $mosesdir/tokenizer/normalize-punctuation.perl -l $src | $mosesdir/tokenizer/tokenizer.perl -a -threads 8 -l $src > $dir/1-tok/opensubs.test.tok.$src
cat $dir/opensubs.test.$trg | $mosesdir/tokenizer/normalize-punctuation.perl -l $trg | $mosesdir/tokenizer/tokenizer.perl -a -threads 8 -l $trg > $dir/1-tok/opensubs.test.tok.$trg
...
$mosesdir/recaser/truecase.perl -model $dir/2-clean/truecase-model.$trg < $dir/1-tok/opensubs.dev.tok.$trg > $dir/3-tc/opensubs.dev.tc.$trg
$mosesdir/recaser/truecase.perl -model $dir/2-clean/truecase-model.$src < $dir/1-tok/opensubs.dev.tok.$src > $dir/3-tc/opensubs.dev.tc.$src
$mosesdir/recaser/truecase.perl -model $dir/2-clean/truecase-model.$trg < $dir/1-tok/opensubs.test.tok.$trg > $dir/3-tc/opensubs.test.tc.$trg
$mosesdir/recaser/truecase.perl -model $dir/2-clean/truecase-model.$src < $dir/1-tok/opensubs.test.tok.$src > $dir/3-tc/opensubs.test.tc.$src
...
subword-nmt apply-bpe -c $dir/4-bpe/model.bpe < $dir/3-tc/opensubs.dev.tc.$trg > $dir/4-bpe/opensubs.dev.bpe.$trg &
subword-nmt apply-bpe -c $dir/4-bpe/model.bpe < $dir/3-tc/opensubs.dev.tc.$src > $dir/4-bpe/opensubs.dev.bpe.$src &
subword-nmt apply-bpe -c $dir/4-bpe/model.bpe < $dir/3-tc/opensubs.test.tc.$trg > $dir/4-bpe/opensubs.test.bpe.$trg &
subword-nmt apply-bpe -c $dir/4-bpe/model.bpe < $dir/3-tc/opensubs.test.tc.$src > $dir/4-bpe/opensubs.test.bpe.$src &
